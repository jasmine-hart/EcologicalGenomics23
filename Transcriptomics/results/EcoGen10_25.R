...
purple <- t_norm.counts_purple - rowMeans(t_norm.counts_purple)
...
pheatmap(t_norm.counts_yellow, color = myColor, breaks = myBreaks,show_colnames = FALSE, show_rownames = FALSE, annotation_col = df, main = "Yellow")
